...
export type SanityBlockOrCenterImageOrLeftImageOrRightImage = SanityBlock | SanityCenterImage | SanityLeftImage | SanityRightImage;
...
export type HeaderQuery = (
  ...
  & { sanityNavigation: Maybe<(
    ...
    & { items: Maybe<Array<Maybe<((
      ...
      & { items: Maybe<Array<Maybe<({ __typename?: 'SanityPageLink' } | { __typename?: 'SanityPlainLink' })
        & AnyNavLinkFragment
      >>> }
    ) | { __typename?: 'SanityPageLink' } | { __typename?: 'SanityPlainLink' })
      & AnyNavLinkFragment
    >>> }
  )> }
);
...
export type MinistryPageQuery = (
  ...
  & { sanityMinistryPage: Maybe<(
    { __typename?: 'SanityMinistryPage' }
    & Pick<SanityMinistryPage, 'name' | '_rawContent' | '_rawSections'>
    & { subLogo: Maybe<(
      { __typename?: 'SanityImage' }
      & { asset: Maybe<(
        { __typename?: 'SanityImageAsset' }
        & { fluid: Maybe<{ __typename?: 'SanityImageFluid' }
    ...
    & { nodes: Array<(
      ...
      & { thumbnail: Maybe<(
        ...
        & { asset: Maybe<(
          { __typename?: 'SanityImageAsset' }
          & { fixed: Maybe<{ __typename?: 'SanityImageFixed' }
